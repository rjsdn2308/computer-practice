...
class SpecialEffect(QMainWindow):
    def __init__(self):
        ...
        choiceButton=QPushButton('선택',self)      
        ...
        choiceButton.setGeometry(510,10,100,30)
        ...
        choiceButton.clicked.connect(self.choiceFunction)    
    ...
    def choiceFunction(self):      
        fname=QFileDialog.getSaveFileName(self,'파일 선택','./')

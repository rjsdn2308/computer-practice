...
class TrafficWeak(QMainWindow):
    def __init__(self):
        ...
        self.signFiles=[['C:/Users/gunwo/anaconda3/envs/TEST/computer/6장/child.png','어린이'],['computer/6장/elder.pngcomputer/6장/elder.png','노인'],['computer/6장/disabled.png','장애인']]	# 표지판 모델 영상
